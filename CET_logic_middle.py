...
def cet_process(input_path, score_path, output_path):
    ...
    #직업환경요인 계산
    df['env_D'] = df[['EJ2-2', 'EJ4-1', 'EJ6-2', 'EJ8-1', 'EJ10-1', 'EJ12-2', 'EJ14-1', 'EJ16-2', 'EJ18-2', 'EJ20-1', 'EJ22-1', 'EJ24-1', 'EJ26-2', 'EJ28-1', 'EJ30-1']].sum(axis=1)
    df['env_I'] = df[['EJ2-1', 'EJ4-2', 'EJ6-1', 'EJ8-2', 'EJ10-2', 'EJ12-1', 'EJ14-2', 'EJ16-1', 'EJ18-1', 'EJ20-2', 'EJ22-2', 'EJ24-2', 'EJ26-1', 'EJ28-2', 'EJ30-2']].sum(axis=1)
    ...
    df_count = df.iloc[:,9:189]
    df_count.notnull().sum(axis=1)

    df['반응적합'] = round((df_count.notnull().sum(axis=1)/180)*100, 2)
